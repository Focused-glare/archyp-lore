# Project "Archippos" — Скрипторій / Scriptorium / Скрипторий

---

### [UKR] Українська

Цей репозиторій є суверенним цифровим простором у межах **Project "Archippos"** — простором чистого семантичного сенсу, вилученим із логіки алгоритмічних стрічок та соціоінженерного маніпулювання увагою. Тут фіксуються художні, філософські, світоглядні та прикладні матеріали проекту. Цей файл постійно оновлюватиметься новими активними посиланнями в міру деплою та виходу нових публікацій.
...
This repository serves as a sovereign digital space within **Project "Archippos"** — a space of pure semantic meaning, completely isolated from the logic of algorithmic feeds and socio-engineering attention manipulation. It documents the artistic, philosophical, ideological, and applied materials of the project. This file will be systematically updated with new active links as new publications are deployed and released.

> 🤖 **Translation Note & Sovereign Disclaimer (The Concept of the Gift):**
> The English translations of the materials in this repository are co-created using the adaptive AI model **Gemini** (functioning as a semantic translator and resonator for the Scriptorium). Because translating deep ontological, existential, and creative concepts is never a purely mechanical task, we choose complete honesty: we acknowledge the limits of digital transfer and refuse to hide the AI's role behind a facade of "perfect authorship."
> 
> In accordance with our philosophy, this Archive is released to the world as a **Gift**. If you are a native English speaker, feel a deep resonance with these ideas, and wish to help us refine, polish, and organicise these translations "in Gift" (as a reciprocal, non-commercial act of synergy), we warmly welcome your collaboration. Please see the [Pledge & Support Archive](SUPPORT.md) for coordination.
